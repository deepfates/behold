...
- `BEHOLD_POLICY_PROFILE` — action-only ordinary `resident-v2` (default), coached legacy `resident-v1`, strategy-minimal evaluation `neutral-benchmark-v1`, or narrated legacy treatment `legible-resident-v1`
