...
The workshop has exercised the underlying qualified Oxford habitat and the
installed Place control seam, but this exact one-resident walkthrough still
needs a clean-room start/stop/resume receipt. A small qualified release also
needs a durable public download coordinate. Passing this candidate will prove
an outsider-runnable First Life alpha; it will not prove the separate repeated
