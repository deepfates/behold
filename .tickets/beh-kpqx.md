...
The bounded convergence milestone is crossed by the ordinary resident-v2 live/lens/stop/resume and exact Textile projection recorded under beh-rhxm and beh-oq26. The implementation now preserves the compact waist: bounded experience → unsteered action-or-yield → admitted bodily attempt → Minecraft consequence → separate continuing own-life history. This closes only this milestone. Open model/perception comparisons remain diagnostics, and sustained rich household-scale resident life remains the product horizon rather than being redefined downward.
